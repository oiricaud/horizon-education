...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fbjs/lib/invariant"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("fbjs/lib/forEachObject"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/mapObject"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"), require("relay-debugger-react-native-runtime"));
		...
		exports["RelayRuntime"] = factory(require("fbjs/lib/invariant"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("fbjs/lib/forEachObject"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/mapObject"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"), require("relay-debugger-react-native-runtime"));
	else
		root["RelayRuntime"] = factory(root["fbjs/lib/invariant"], root["babel-runtime/helpers/classCallCheck"], root["fbjs/lib/warning"], root["fbjs/lib/forEachObject"], root["babel-runtime/helpers/extends"], root["fbjs/lib/areEqual"], root["fbjs/lib/emptyFunction"], root["fbjs/lib/removeFromArray"], root["babel-runtime/helpers/defineProperty"], root["babel-runtime/helpers/toConsumableArray"], root["fbjs/lib/mapObject"], root["fbjs/lib/resolveImmediate"], root["fbjs/lib/sprintf"], root["relay-debugger-react-native-runtime"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_29__, __WEBPACK_EXTERNAL_MODULE_30__, __WEBPACK_EXTERNAL_MODULE_31__, __WEBPACK_EXTERNAL_MODULE_64__, __WEBPACK_EXTERNAL_MODULE_65__, __WEBPACK_EXTERNAL_MODULE_66__, __WEBPACK_EXTERNAL_MODULE_67__, __WEBPACK_EXTERNAL_MODULE_68__, __WEBPACK_EXTERNAL_MODULE_69__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  RecordSource: __webpack_require__(13),
	  ...
	  ConnectionInterface: __webpack_require__(11)
	};

	if (true) {
	  var RelayRecordSourceInspector = __webpack_require__(23);
	...
	function createFragmentSpecResolver(context, containerName, fragments, props, callback) {
	  if (true) {
	    ...
	    fragmentNames.forEach(function (fragmentName) {
	      ...
	      __webpack_require__(6)(propValue !== undefined, 'createFragmentSpecResolver: Expected prop `%s` to be supplied to `%s`, but ' + 'got `undefined`. Pass an explicit `null` if this is intentional.', fragmentName, containerName);
	    });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function update(store, payload) {
	  ...
	  var _RelayConnectionInter = __webpack_require__(11).get(),
	  ...
	  if (!clientConnection) {
	    ...
	    var connection = store.create(__webpack_require__(12)(record.getDataID(), payload.handleKey), serverConnection.getType());
	    ...
	    clientPageInfo = store.create(__webpack_require__(12)(connection.getDataID(), PAGE_INFO), PAGE_INFO_TYPE);
	    ...
	    if (prevEdges && _serverEdges) {
	      if (args.after != null) {
	        ...
	        if (clientPageInfo && args.after === clientPageInfo.getValue(END_CURSOR)) {
	          ...
	          __webpack_require__(6)(false, 'RelayConnectionHandler: Unexpected after cursor `%s`, edges must ' + 'be fetched from the end of the list (`%s`).', args.after, clientPageInfo && clientPageInfo.getValue(END_CURSOR));
	          return;
	        }
	        ...
	        if (clientPageInfo && args.before === clientPageInfo.getValue(START_CURSOR)) {
	          ...
	          __webpack_require__(6)(false, 'RelayConnectionHandler: Unexpected before cursor `%s`, edges must ' + 'be fetched from the beginning of the list (`%s`).', args.before, clientPageInfo && clientPageInfo.getValue(START_CURSOR));
	          return;
	        }
	      } else {
	...
	function insertEdgeAfter(record, newEdge, cursor) {
	  var _RelayConnectionInter2 = __webpack_require__(11).get(),
	...
	function createEdge(store, record, node, edgeType) {
	  var _RelayConnectionInter3 = __webpack_require__(11).get(),
	  ...
	  var edgeID = __webpack_require__(12)(record.getDataID(), node.getDataID());
	...
	function insertEdgeBefore(record, newEdge, cursor) {
	  var _RelayConnectionInter4 = __webpack_require__(11).get(),
	...
	function deleteNode(record, nodeID) {
	  var _RelayConnectionInter5 = __webpack_require__(11).get(),
	...
	function buildConnectionEdge(store, connection, edge) {
	  ...
	  var _RelayConnectionInter6 = __webpack_require__(11).get(),
	  ...
	  var edgeID = __webpack_require__(12)(connection.getDataID(), EDGES, edgeIndex);
	...
	function mergeEdges(sourceEdges, targetEdges, nodeIDs) {
	  var _RelayConnectionInter7 = __webpack_require__(11).get(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EXISTENT = __webpack_require__(15).EXISTENT,
	    NONEXISTENT = __webpack_require__(15).NONEXISTENT,
	    UNKNOWN = __webpack_require__(15).UNKNOWN;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function normalizeRelayPayload(selector, payload, errors) {
	  ...
	  var source = new (__webpack_require__(13))();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayObservable = function () {
	  ...
	  RelayObservable.from = function from(obj) {
	    return isObservable(obj) ? fromObservable(obj) : __webpack_require__(59)(obj) ? fromPromise(obj) : obj instanceof Error ? fromError(obj) : fromValue(obj);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function rangeAdd(config, operation) {
	  ...
	  if (!parentID) {
	    __webpack_require__(6)(false, 'setRelayModernMutationConfigs: For mutation config RANGE_ADD ' + 'to work you must include a parentID');
	    return;
	  }
	  var rootField = getRootField(operation);
	            ...
	            if (serverEdge) {
	              ...
	              switch (info.rangeBehavior) {
	                ...
	                case 'prepend':
	                  ...
	                  break;
	                default:
	                  __webpack_require__(6)(false, 'setRelayModernMutationConfigs: RANGE_ADD range behavior ' + ('\'' + info.rangeBehavior + '\' will not work as expected in RelayModern, ') + "supported range behaviors are 'append', 'prepend', and " + "'ignore'");
	                  break;
	              }
	            }
	          }
	...
	function rangeDelete(config, operation) {
	  ...
	  if (!parentID) {
	    __webpack_require__(6)(false, 'setRelayModernMutationConfigs: For mutation config RANGE_DELETE ' + 'to work you must include a parentID');
	    return;
	  }
	  var rootField = getRootField(operation);
	  if (rootField) {
	...
	function deleteNode(parentID, connectionKeys, pathToConnection, store, deleteIDs) {
	  __webpack_require__(6)(connectionKeys, 'setRelayModernMutationConfigs: RANGE_DELETE must provide a ' + 'connectionKeys');
	  var parent = store.get(parentID);
	  if (!parent) {
	    return;
	  }
	  if (pathToConnection.length >= 2) {
	    ...
	    if (connectionKeys && recordProxy) {
	      ...
	      __webpack_require__(6)(false, 'setRelayModernMutationConfigs: RANGE_DELETE ' + 'pathToConnection is incorrect. Unable to find connection with ' + 'parentID: %s and path: %s', parentID, pathToConnection.toString());
	    }
	  } else {
	    __webpack_require__(6)(false, 'setRelayModernMutationConfigs: RANGE_DELETE ' + 'pathToConnection must include at least parent and connection');
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getOperationVariables(operation, variables) {
	  ...
	  operation.query.argumentDefinitions.forEach(function (def) {
	    ...
	    if (true) {
	      __webpack_require__(6)(value != null || def.type[def.type.length - 1] !== '!', 'RelayConcreteVariables: Expected a value for non-nullable variable ' + '`$%s: %s` on operation `%s`, got `%s`. Make sure you supply a ' + 'value for all non-nullable arguments.', def.name, def.type, operation.name, JSON.stringify(value));
	    }
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getSelector(operationVariables, fragment, item) {
	  ...
	  __webpack_require__(6)(false, 'RelayModernSelector: Expected object to contain data for fragment `%s`, got ' + '`%s`. Make sure that the parent operation/fragment included fragment ' + '`...%s` without `@relay(mask: false)`.', fragment.name, JSON.stringify(item), fragment.name);
	  return null;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VIEWER_ID = __webpack_require__(12)(ROOT_ID, 'viewer');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function convertFetch(fn) {
	  return function fetch(operation, variables, cacheConfig, uploadables) {
	    return __webpack_require__(21).from(fn(operation, variables, cacheConfig, uploadables));
	  };
	}
	...
	function convertSubscribe(fn) {
	  return function subscribe(operation, variables, cacheConfig) {
	    return __webpack_require__(21).fromLegacy(function (observer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EnvironmentDebugger = function () {
	  ...
	  EnvironmentDebugger.prototype.getMatchingRecords = function getMatchingRecords(matchStr, matchType) {
	    var inspector = __webpack_require__(23).getForEnvironment(this._environment);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayMarkSweepStore = function () {
	  ...
	  RelayMarkSweepStore.prototype.lookup = function lookup(selector) {
	    var snapshot = __webpack_require__(22).read(this._recordSource, selector);
	    if (true) {
	  ...
	  RelayMarkSweepStore.prototype._updateSubscription = function _updateSubscription(subscription) {
	    ...
	    var _RelayReader$read = __webpack_require__(22).read(this._recordSource, snapshot),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayModernEnvironment = function () {
	  function RelayModernEnvironment(config) {
	    ...
	    if (true) {
	      ...
	      if (typeof g.registerDevtoolsPlugin === 'function') {
	        g.registerDevtoolsPlugin(__webpack_require__(69));
	      }
	  ...
	  RelayModernEnvironment.prototype.observe = function observe(_ref2) {
	    ...
	    return this._network.observe(node, variables, cacheConfig || {}).map(function (payload) {
	      return __webpack_require__(38)(node, variables, payload);
	    })['do']({
	  ...
	  RelayModernEnvironment.prototype.checkSelectorAndUpdateStore = function checkSelectorAndUpdateStore(selector, handlers) {
	    var target = new (__webpack_require__(13))();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayPublishQueue = function () {
	  ...
	  function RelayPublishQueue(store, handlerProvider) {
	    ...
	    this._backup = new (__webpack_require__(13))();
	    this._handlerProvider = handlerProvider || null;
	  ...
	  RelayPublishQueue.prototype._commitUpdaters = function _commitUpdaters() {
	    ...
	    var sink = new (__webpack_require__(13))();
	...
	function lookupSelector(source, selector) {
	  var selectorData = __webpack_require__(22).read(source, selector).data;
	  if (true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayRecordProxy = function () {
	  ...
	  RelayRecordProxy.prototype.getOrCreateLinkedRecord = function getOrCreateLinkedRecord(name, typeName, args) {
	    ...
	    if (!linkedRecord) {
	      var storageKey = args ? __webpack_require__(7)(name, args) : name;
	      var clientID = __webpack_require__(12)(this.getDataID(), storageKey);
	...
	var RelayResponseNormalizer = function () {
	  ...
	  RelayResponseNormalizer.prototype._normalizeField = function _normalizeField(selection, record, data) {
	    ...
	    if (fieldValue == null) {
	      ...
	      if (true) {
	        __webpack_require__(6)(Object.prototype.hasOwnProperty.call(data, responseKey), 'RelayResponseNormalizer(): Payload did not contain a value ' + 'for field `%s: %s`. Check that you are parsing with the same ' + 'query that was used to fetch the payload.', responseKey, storageKey);
	      }
	  ...
	  RelayResponseNormalizer.prototype._normalizeLink = function _normalizeLink(field, record, storageKey, fieldValue) {
	    ...
	    __webpack_require__(2).getLinkedRecordID(record, storageKey) || __webpack_require__(12)(__webpack_require__(2).getDataID(record), storageKey);
	  ...
	  RelayResponseNormalizer.prototype._normalizePluralLink = function _normalizePluralLink(field, record, storageKey, fieldValue) {
	    ...
	    fieldValue.forEach(function (item, nextIndex) {
	      ...
	      __webpack_require__(12)(__webpack_require__(2).getDataID(record), storageKey, nextIndex);
	  ...
	  RelayResponseNormalizer.prototype._validateRecordType = function _validateRecordType(record, field, payload) {
	    ...
	    __webpack_require__(6)(__webpack_require__(2).getType(record) === typeName, 'RelayResponseNormalizer: Invalid record `%s`. Expected %s to be ' + 'be consistent, but the record was assigned conflicting types `%s` ' + 'and `%s`. The GraphQL server likely violated the globally unique ' + 'id requirement by returning the same id for different objects.', __webpack_require__(2).getDataID(record), TYPENAME_KEY, __webpack_require__(2).getType(record), typeName);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function commitRelayModernMutation(environment, config) {
	  ...
	  if (typeof optimisticResponse === 'function') {
	    optimisticResponse = optimisticResponse();
	    __webpack_require__(6)(false, 'commitRelayModernMutation: Expected `optimisticResponse` to be an object, ' + 'received a function.');
	  }
	  if (optimisticResponse && mutation.query.selections && mutation.query.selections.length === 1 && mutation.query.selections[0].kind === 'LinkedField') {
	    ...
	    __webpack_require__(6)(optimisticResponse[mutationRoot], 'commitRelayModernMutation: Expected `optimisticResponse` to be wrapped ' + 'in mutation name `%s`', mutationRoot);
	  }
	  if (configs) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function requestRelaySubscription(environment, config) {
	  ...
	  __webpack_require__(6)(!(updater && configs), 'requestRelaySubscription: Expected only one of `updater` and `configs` to be provided');
