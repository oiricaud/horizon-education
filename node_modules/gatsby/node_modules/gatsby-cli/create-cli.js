...
function buildLocalCommands(cli, isLocalSite) {
  ...
  function resolveLocalCommand(command) {
    ...
    try {
      const cmdPath = resolveCwd.silent(`gatsby/dist/commands/${command}`) ||
  ...
  function getCommandHandler(command, handler) {
    return argv => {
      ...
      let args = (0, _extends3.default)({}, argv, siteInfo);
...
module.exports = (argv, handlers) => {
  ...
  return cli.command({
    ...
    handler: handlerP(({ rootPath, starter = `gatsbyjs/gatsby-starter-default` }) => {
